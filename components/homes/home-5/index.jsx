...
import NewsLetter from "./articlesLetter";
              ...
              <div>
                <div className="wow linesAnimIn" data-splitting="lines">
                  <h2 className="section-title mb-30 mb-sm-20">
                    <span className="text-gray">About</span> Euphoria
                    <span className="text-gray">.</span>
                  </h2>
                  <div className="text-gray mb-30 mb-sm-20">
                    <p className="mb-0">
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                      Vero facere blanditiis hic adipisci porro rerum omnis
                      optio voluptatem, quo natus obcaecati voluptate corporis
                      dignissimos harum perferendis, itaque consequuntur
                      quibusdam. Esse soluta iusto excepturi perspiciatis illum
                      dignissimos velit aut laborum numquam. Libero qui rem
                      dignissimos, distinctio, dicta repellat illo consectetur
                      ad quia voluptate necessitatibus quisquam labore vitae
                      pariatur eaque architecto? Saepe!
                    </p>
                  </div>
                </div>
              ...
              <div className="row small-section">
                <div className="col-xl-11">
                  ...
                  <div className="text-gray mb-30 mb-sm-20">
                    <p className="mb-0">
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Tempora cum esse reprehenderit porro! Corrupti et eveniet
                      ea, molestias illum perspiciatis.
                    </p>
                  </div>
