...
import NewsLetter from "@/components/homes/home-1/articlesLetter";
        ...
        <div className="container position-relative">
          <div className="row mb-60 mb-xs-30">
            <div className="col-md-6">
              <h2 className="section-caption mb-xs-10">About Euphoria</h2>
              <h3 className="section-title mb-0">
                <AnimatedText text="Better way to build your dreams." />
              </h3>
            </div>
